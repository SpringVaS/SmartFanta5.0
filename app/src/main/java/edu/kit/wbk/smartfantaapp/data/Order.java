...
public class Order implements Serializable {
    ...
    public static Order getOrderOne() {
       String [][] o = {{"i","1"},{"Getriebegehäuse Typ 4 1395107154","1"},{"Anker Typ 4 3134017958","6"},{"Buerstenhalter Typ 2 3134340867","1"}};
       String  v = "1";
       String a [] = {"2"};
    ...
    public static Order getOrderTwo() {
       String [][] o = {{"Buerstenhalter Typ 2 3134340867","1"},{"Getriebedeckel (Typ 6)1391073305", "1"},{"Poltopf kurz 3135000183", "3"}};
       String a []= {"1"};
       String v = "2";
