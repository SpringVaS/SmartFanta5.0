...
public class Order {
    ...
    public Order getOrderOne() {
       ...
       String  v = "1";
       String a [] = {"2"};
       String [][] names = {{"Magnet","4"},{"Getriebegehäuse Typ 4","1"}, {"Anker Typ 4","4"}, {"Bürstenhalter Typ 2","3"}};
    ...
    public Order getOrderTwo() {
       ...
       String a []= {"1"};
       String v = "2";
       String [][] names = {{"Bürstenhalter Typ","3"}, {"Getriebedeckel (Typ 6)","1"},{"Poltopf kurz","4"}};
       return new Order(v,o,a,names,2,"start");
    }
    public Order getRefillOrder() {
        String vnr = "1";
